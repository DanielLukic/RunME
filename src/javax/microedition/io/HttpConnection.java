...
public interface HttpConnection extends ContentConnection
    ...
    void setRequestMethod( String aString ) throws IOException;

    String getRequestProperty( String aString );

    void setRequestProperty( String aString, String aString1 ) throws IOException;
    ...
    String getHeaderField( String aString ) throws IOException;

    int getHeaderFieldInt( String aString, int i ) throws IOException;

    long getHeaderFieldDate( String aString, long l ) throws IOException;
